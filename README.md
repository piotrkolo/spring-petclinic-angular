# Spring Caseservice Angular [![Build Status](https://travis-ci.org/spring-caseservice/spring-caseservice-angular.png?branch=master)](https://travis-ci.org/spring-caseservice/spring-caseservice-angular/)
